<template>
  <div id="app">
    ...
    <table class="table">
      ...
      <tbody>
      <tr class="content" v-for="e in entrees" :key="e">
        <td>{{ e.titre }}</td>
        <td>{{ e.prix }} euros</td>
      </tr>
      </tbody>
    ...
    <table class="table">
      ...
      <tbody>
      <tr class="content" v-for="p in platsPrincipals" :key="p">
        <td>{{ p.titre }}</td>
        <td>{{ p.prix }} euros</td>
      </tr>
      </tbody>
    ...
    <table class="table">
      ...
      <tbody>
      <tr class="content" v-for="d in dessert" :key="d">
        <td>{{ d.titre }}</td>
        <td>{{ d.prix }} euros</td>
      </tr>
      </tbody>
    ...
    return {
      ...
      listPlats: {
        titre: [
          ...
          'Farce pour volaille',
          'Pavé de saumon en croûte de sel. Sauce express pour poisson blanc : moutarde-basilic', 'Toasts aux sardines. Pétoncles sauce curry',
